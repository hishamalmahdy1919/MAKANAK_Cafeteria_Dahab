...
SAFARI_TRIPS = [
    ...
    },
    {
        ...
        "lines": {
            "ar": ["الذهاب بالمركب", "الانتقال بالسيارة إلى أبو جالوم", "ممارسة سنوركلينج + Drink", "الانتقال بالسيارة إلى محمية بلو لاجون", "ممارسة سنوركلينج + Drink", "العودة إلى المركب ثم العودة إلى البلو هول", "سنوركلينج", "وجبة غداء ربع فراخ مشوية وعيش وسلطة وطحينة", "شاملة لايف جاكيت + حذاء", '<span style="color:red; font-weight:bold;">المصريين 1500LE - أجنبي 35$</span>'],
            "en": ["Boat ride", "Car transfer to Abu Galum", "Snorkeling + Drink", "Car transfer to Blue Lagoon", "Snorkeling + Drink", "Return to boat, then to Blue Hole", "Snorkeling", "Lunch: 1/4 Grilled chicken meal", "Includes Life Jacket + Water Shoes", '<span style="color:red; font-weight:bold;">Egyptians 1500LE - Foreigner 35$</span>']
        }
    }
]
...
T = {
 "en": dict(label="English", dir="ltr",
   ...
   booking_form_title="Book Safari Trip", booking_date="Trip Date:", booking_name="Full Name:", booking_phone="Phone Number:", booking_wa="WhatsApp Number:", booking_btn="Done (Confirm Booking)", instapay_btn="Pay via InstaPay", toast_msg="InstaPay is opening...",
 ...
 "ar": dict(label="العربية", dir="rtl",
   ...
   booking_form_title="حجز رحلة سفاري", booking_date="تاريخ الرحلة:", booking_name="الاسم بالكامل:", booking_phone="رقم الهاتف:", booking_wa="رقم الواتساب:", booking_btn="تم (تأكيد الحجز)", instapay_btn="الدفع عبر إنستاباي", toast_msg="جاري فتح تطبيق إنستاباي...",
 ...
 "ru": dict(label="Русский", dir="ltr", nav_courses="Курсы", nav_includes="Включено", nav_crossover="Кроссовер", nav_safari="Сафари", nav_contact="Контакты",
   ...
   booking_form_title="Забронировать сафари", booking_date="Дата поездки:", booking_name="Полное имя:", booking_phone="Номер телефона:", booking_wa="Номер WhatsApp:", booking_btn="Готово (Подтвердить)", instapay_btn="Оплатить через InstaPay", toast_msg="Открытие InstaPay...",
 ...
 "it": dict(label="Italiano", dir="ltr", nav_courses="Corsi", nav_includes="Incluso", nav_crossover="Crossover", nav_safari="Safari", nav_contact="Contatti",
   ...
   booking_form_title="Prenota Safari", booking_date="Data del viaggio:", booking_name="Nome e cognome:", booking_phone="Numero di telefono:", booking_wa="Numero WhatsApp:", booking_btn="Fatto (Conferma)", instapay_btn="Paga tramite InstaPay", toast_msg="Apertura InstaPay...",
 ...
 "fr": dict(label="Français", dir="ltr", nav_courses="Cours", nav_includes="Inclus", nav_crossover="Crossover", nav_safari="Safari", nav_contact="Contact",
   ...
   booking_form_title="Réserver un Safari", booking_date="Date du voyage :", booking_name="Nom complet :", booking_phone="Numéro de téléphone :", booking_wa="Numéro WhatsApp :", booking_btn="Terminé (Confirmer)", instapay_btn="Payer via InstaPay", toast_msg="Ouverture d'InstaPay...",
 ...
 "de": dict(label="Deutsch", dir="ltr", nav_courses="Kurse", nav_includes="Inklusive", nav_crossover="Crossover", nav_safari="Safari", nav_contact="Kontakt",
   ...
   booking_form_title="Safari Buchen", booking_date="Reisedatum:", booking_name="Vollständiger Name:", booking_phone="Telefonnummer:", booking_wa="WhatsApp-Nummer:", booking_btn="Fertig (Bestätigen)", instapay_btn="Mit InstaPay bezahlen", toast_msg="InstaPay wird geöffnet...",
 ...
 "zh": dict(label="中文", dir="ltr", nav_courses="课程", nav_includes="包含", nav_crossover="转换", nav_safari="游猎", nav_contact="联系",
   ...
   booking_form_title="预订游猎行程", booking_date="行程日期:", booking_name="姓名:", booking_phone="电话号码:", booking_wa="WhatsApp号码:", booking_btn="完成 (确认预订)", instapay_btn="通过InstaPay付款", toast_msg="正在打开InstaPay...",
 ...
 "es": dict(label="Español", dir="ltr", nav_courses="Cursos", nav_includes="Incluido", nav_crossover="Crossover", nav_safari="Safari", nav_contact="Contacto",
   ...
   booking_form_title="Reservar Safari", booking_date="Fecha del viaje:", booking_name="Nombre completo:", booking_phone="Número de teléfono:", booking_wa="Número de WhatsApp:", booking_btn="Hecho (Confirmar)", instapay_btn="Pagar con InstaPay", toast_msg="Abriendo InstaPay...",
...
<main>
  ...
  <section class="section alt bg-sea" id="why">
  ...
  <section class="section" id="courses">
    ...
    <div style="text-align: center; margin-top: 20px;">
      <button class="book-now-btn" style="max-width: 300px; font-size: 1.1rem; padding: 12px;" onclick="openBooking('{esc(t.get('nav_courses', 'Freediving Course'))}')">{esc(t.get("booking_form_title", "Book Now"))}</button>
    </div>
  </section>

  <section class="section alt bg-divers" id="includes">
  ...
  <section class="section bg-desert" id="safari">
...
<div id="bookingModal" class="lightbox">
  <div class="lightbox-content booking-modal-content">
    ...
    <form action="YOUR_EMAIL_LINK" method="POST" class="booking-form">
      ...
      <button type="button" class="instapay-btn" onclick="openInstaPay('{INSTAPAY_ADDRESS}')">
